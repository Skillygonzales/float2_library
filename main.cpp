...
int main() {
    ...
    std::cout << "double2 precision additon = " << float128_to_string(c2) << std::endl;
    ...
    std::cout << "double2 precision subtraction = " << float128_to_string(d2) << std::endl;
    ...
    std::cout << "double2 precision multiplication = " << float128_to_string(e2) << std::endl;
    ...
    std::cout << "double2 precision division = " << float128_to_string(f2) << std::endl;
    ...
    std::cout << "double2 precision square = " << float128_to_string(g2) << std::endl;
    ...
    file_add  << "fp64 precision addition,double2 precision addition,fp128 precision addition\n";
    file_sub  << "fp64 precision subtraction,double2 precision subtraction,fp128 precision subtraction\n";
    file_mul  << "fp64 precision multiplication,double2 precision multiplication,fp128 precision multiplication\n";
    file_div  << "fp64 precision division,double2 precision division,fp128 precision division\n";
    file_sqr  << "fp64 precision square,double2 precision square,fp128 precision square\n";
    file_sqrt << "fp64 precision square root,double2 precision square root,fp128 precision square root\n";
    ...
    for(int i = 0; i < 1000; i++) {
        ...
        std::cout << "double2 precision additon = " << float128_to_string(c2_test) << std::endl;
        ...
        std::cout << "double2 precision subtraction = " << float128_to_string(d2_test) << std::endl;
        ...
        std::cout << "double2 precision multiplication = " << float128_to_string(e2_test) << std::endl;
        ...
        std::cout << "double2 precision division = " << float128_to_string(f2_test) << std::endl;
        ...
        std::cout << "double2 precision square = " << float128_to_string(g2_test) << std::endl;
        ...
        std::cout << "double2 precision square root = " << float128_to_string(h2_test) << std::endl;
