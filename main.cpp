...
int main() {
    ...
    std::cout << std::setprecision(15) << "fp64 precision additon   = " << c1 << std::endl;
    ...
    std::cout << std::setprecision(15) << "fp64 precision subtraction   = " << d1 << std::endl;
    ...
    std::cout << std::setprecision(15) << "fp64 precision multiplication   = " << e1 << std::endl;
    ...
    std::cout << std::setprecision(15) << "fp64 precision division   = " << f1 << std::endl;
    ...
    std::cout << std::setprecision(15) << "fp64 precision square   = " << g1 << std::endl;
    ...
    std::cout << std::setprecision(15) << "fp64 precision square root  = " << h1 << std::endl;
